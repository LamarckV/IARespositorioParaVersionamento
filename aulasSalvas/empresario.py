...
from langchain_core.prompts import AIMessagePromptTemplate, ChatMessagePromptTemplate, ChatPromptTemplate, FewShotChatMessagePromptTemplate, HumanMessagePromptTemplate, MessagesPlaceholder
...
while True:
    ...
    try:
        resposta = chain.invoke(
            {'usuario':user_input},
            config={'configurable':{'session_id':'PRECISA_MAIS_NAO_IMPORTA'}},
        )
        print(resposta)
